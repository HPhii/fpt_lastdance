...
], function (BaseController, JSONModel)
{
  ...
  return BaseController.extend("z.wf.zwfmanagement.controller.Analytics", {
    onInit: function ()
    {
      ...
      this.oRouter.getRoute("RouteAnalytics").attachPatternMatched(this._onObjectMatched, this);
    },
    ...
    _onObjectMatched: function (oEvent)
    {
      ...
      oStatsAnalyticsModel.read("/ZC_GSP26SAP02_WF_ANALYTICS", {
        urlParameters: {
          "$select": "IsOpenCount,IsCompletedThisMonth,IsOverdueCount,TaskCounter,IsCompletedCount",
        },
